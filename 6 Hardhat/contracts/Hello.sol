...
//voir les licenses possibles : https://spdx.org/licenses/
...
contract Hello {
    ...
    // toutes les fonctions qui n'effectuent pas d'operations sont des fonctions de type view celle ci retourne un string (memory est  à ajouter si nous sommes dans le cas d'un string ou d'un tableau (string etant un tableau)
